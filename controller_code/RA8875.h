...
public:
  ...
  uint8_t reg_read(spi_inst_t *spi, const uint8_t reg, uint8_t *buf, const uint8_t nbytes);
  void reg_write(spi_inst_t *spi, const uint8_t reg, uint8_t data);
...
private:
  ...
  uint8_t  cs_pin, sck_pin, mosi_pin, miso_pin;
